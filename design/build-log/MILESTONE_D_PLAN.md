...
Guiding rule ([design-notes.md](../design-notes.md) §14.4): **progress is credited
...
| 13 | Regression pass; wire it all; update [STATUS.md](../STATUS.md) + the connective index; write `../nexus/MILESTONE_D_NOTES.md`. |
...
## 7. Tunable starting values (recalibrate from data — design-notes §14.4)
...
- `../nexus/MILESTONE_D_NOTES.md` — what is real after D, what remains stubbed.
