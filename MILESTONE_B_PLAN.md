...
> **Cross-reference**
> - Role: The concrete build plan for the first end-to-end slice — the "dumb slice" that tests the core premise.
> - Authority: Implementation plan; subordinate to the Complete Claude-Code Spec and [DESIGN_TIGHTENING.md](DESIGN_TIGHTENING.md).
> - Upstream (consumes): [IMPLEMENTATION_PLAN.md](03_IMPLEMENTATION_FOUNDATION/prior_foundation/docs/implementation/IMPLEMENTATION_PLAN.md) milestone B, [DESIGN_TIGHTENING.md](DESIGN_TIGHTENING.md) §1 (object flow), §2 (interfaces), §5 (verification), §15 (Choice B).
> - Downstream (depended on by): Milestones C–I; [IMPLEMENTATION_STATUS.md](02_CONTEXT_AND_TRACEABILITY/IMPLEMENTATION_STATUS.md); the routing and verification decisions that need real data.
> - Wiring: this plan builds the minimum of [DESIGN_TIGHTENING.md](DESIGN_TIGHTENING.md) §1 with every downstream subsystem stubbed at a named seam.
...
This is the **Choice B** slice ([DESIGN_TIGHTENING.md](DESIGN_TIGHTENING.md) §15.2): the
...
The minimum of [DESIGN_TIGHTENING.md](DESIGN_TIGHTENING.md) §1:
...
Minimal cut of [ACCEPTANCE.md](03_IMPLEMENTATION_FOUNDATION/prior_foundation/docs/testing/ACCEPTANCE.md):
...
- [IMPLEMENTATION_STATUS.md](02_CONTEXT_AND_TRACEABILITY/IMPLEMENTATION_STATUS.md) and the
  [connective index](02_CONTEXT_AND_TRACEABILITY/REQUIREMENT_TRACEABILITY.md) updated: event
