...
design-notes sections 1 and 3 that the end-to-end flow needs:
...
(design-notes section 1): objective + >=1 success criterion + a
...
class TaskContract(BaseModel):
    ...
    # design-notes §11.1 — filled by the Interpreter per task_class, user-overridable.
...
"""design-notes section 12 / 14.3. `user` and `workspace` authorise; the
...
class ModelRunRecord(BaseModel):
    ...
    input_tokens: int = 0
    output_tokens: int = 0
    # link to a VerificationRecord.id once the run is "scored" (design-notes section 7)
...
# --------------------------------------------------------------------------- #
# routing + hardware (Milestone G; design-notes §7)
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# research pipeline (Milestone K; design-notes §10.2 domain 2, §12)
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# repo intelligence (Milestone J; design-notes §10.2)
# --------------------------------------------------------------------------- #
