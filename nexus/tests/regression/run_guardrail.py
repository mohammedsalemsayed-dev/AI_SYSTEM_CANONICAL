...
(MILESTONE_I_PLAN.md §2, design-notes §8, §11.2).
...
(aggregate drop > 2 pp, or any previously-passing guardrail task now failing).
    ...
    python -m tests.regression.run_guardrail --set-baseline --memory nexus/guardrail.db
    # later runs — gate against it:
    python -m tests.regression.run_guardrail --memory nexus/guardrail.db
